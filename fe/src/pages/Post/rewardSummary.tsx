...
export default (props: any) => {
  ...
  return (
    <div className="flex justify-center">
      <div className="w-1/2 flex border-r border-gray-500 justify-end flex-wrap">
        {Object.keys(amountMap).map((asset: any) => {
          return (
            <div className="flex items-center justify-center py-2 w-1/2" key={asset}>
      ...
      <div className="w-1/2 py-2">
        <div className="pl-5 flex">
          {users.map((user: any) => {
            return (
              <div className="border border-gray-400 ml-1" key={user.id}>
